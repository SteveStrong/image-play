...
with object tracking for a single object.
...
class OpenCVVideoProcessor():
    ...
    def run_video(self):
        ...
        # Initialize  bounding box coordinates of object to be tracked
        track_bound_box = None
        track_success   = False
        ...
        while True:
            ...
            if track_bound_box:
                ...
                # Check if the tracking successful
                if track_success:
            ...
            if key == ord('s'):
                ...
                self.tracker.init(frame, track_bound_box)
